    ...
    <footer className={styles.footer}>
      <div className={`container ${styles.footerContainer}`}>
        <div className={styles.brandCol}>
          <img src={logo} alt="Expresso Leonidas" className={styles.logo} />
          <p className={styles.description}>
            Conectamos empresas, cargas e destinos com rapidez, tecnologia e segurança. A logística premium que sua empresa merece.
          </p>
        ...
        <div className={styles.linksCol}>
          ...
          <ul>
            ...
            <li><a href="#mapa">Área de Atuação</a></li>
        ...
        <div className={styles.contactCol}>
          ...
          <ul>
            ...
            <li>
              ...
              <a href={`mailto:${SITE_CONFIG.email}`} className={styles.contactLink}>{SITE_CONFIG.email}</a>
            </li>
            <li>
        ...
        <div className={`container ${styles.bottomContainer}`}>
          ...
          <div className={styles.bottomRight}>
            <span className={styles.developedBy}>
              Desenvolvido por{' '}
              <a href="https://www.edgeweb.com.br" target="_blank" rel="noopener noreferrer" className={styles.edgeLink}>
                EDGE web
              </a>
            </span>
